...
func main() {
	...
	doublyLinkedList.Push("Bruno")
	fmt.Println(doublyLinkedList.ToString())
	doublyLinkedList.Push("Gabriel")
	fmt.Println(doublyLinkedList.ToString())
	doublyLinkedList.Push("Lemes")
	fmt.Println(doublyLinkedList.ToString())
	doublyLinkedList.Push("De")
	fmt.Println(doublyLinkedList.ToString())
	doublyLinkedList.Push("Magalhães")
	fmt.Println(doublyLinkedList.ToString())
}
